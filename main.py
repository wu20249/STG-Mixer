...
#气象数据：平均气温 降水量 平均风速 平均湿度 平均气压
#Average Temperature, Precipitation, Average Wind Speed, Average Humidity, Average Atmospheric Pressure
DATA_PATHS = {
...
def main_supervised(args):
    ...
    trainer = pl.Trainer.from_argparse_args(args, callbacks=callbacks,deterministic=False, accelerator='gpu', devices=[0])
